...
const ReasonDiv = ({ hedding, text, index }) => {
  const svgContent1 = (
  ...
  return (
    <div
      className="relative bg-zinc-800 rounded-2xl border-2 border-white border-opacity-20  
      flex-1 p-4 text-white pb-28"
    >
      <h1 className="text-lg font-bold break-words text-white mb-2">
        {hedding}
      </h1>
      <p className="text-sm break-words text-gray-400">{text}</p>
